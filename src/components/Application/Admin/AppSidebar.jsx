    ...
    <Sidebar className="z-50">
      <SidebarHeader className="border-b h-14 p-0">
        <div className='flex justify-between items-center px-4'>
            ...
            <Button onClick={toggleSidebar} type="button" sizee="icon" className="md:hidden" >
            <IoMdClose/>
            </Button>
            ...
            {adminAppSidebarMenu.map((menu,index)=>(
                <Collapsible key={index} className='group/collapsible'>
                    <SidebarMenuItem>
                        ...
                        <LuChevronRight className='ml-auto group-data-[state=open]:rotate-90 transition-transform duration-200
